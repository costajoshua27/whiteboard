            ...
            function (require, module, exports) {
                ...
                function p(e) {
                    ...
                    if (t.mozGetUserMedia)
                        ...
                        (n.browser = "edge"), (n.version = o(t.userAgent, /Edge\/(\d+).(\d+)$/, 2));
                    else {
                ...
                (r.localCName = r.generateIdentifier()),
                    ...
                    (r.writeExtmap = function (r) {
                        return (
                            "a=extmap:" +
                            (r.id || r.preferredId) +
                            (r.direction && "sendrecv" !== r.direction ? "/" + r.direction : "") +
                            " " +
                            r.uri +
                            "\r\n"
                        );
        ...
        NJ2u: [
            function (require, module, exports) {
                ...
                module.exports = function (c, d) {
                    function p(e, t) {
                        t.addTrack(e),
                            t.dispatchEvent(new c.MediaStreamTrackEvent("addtrack", { track: e }));
                    }
                    function l(e, t, r, n) {
                    ...
                    var f = function (t) {
                        ...
                        switch (
                            (t.rtcpMuxPolicy || (t.rtcpMuxPolicy = "require"), t.iceTransportPolicy)
                        ) {
                            case "all":
                            case "relay":
                                break;
                    ...
                    Object.defineProperty(f.prototype, "localDescription", {
                                ...
                                u.forEach(function (i, o) {
                                    ...
                                    if (
                                        ...
                                        var O = e.parseRtcpParameters(i),
                                            G =
                                                e.matchPrefix(i, "a=end-of-candidates", v).length >
                                                0,
                                            j = e
                        ...
                        (f.prototype.createAnswer = function () {
                            ...
                            if (t._isClosed)
                                return Promise.reject(
                                    o("InvalidStateError", "Can not call createAnswer after close")
                                );
                            if (
                ...
                function a(n) {
                    ...
                    (n.RTCPeerConnection = function (r) {
                        return (
                            r &&
                                r.iceServers &&
                                ((r.iceServers = (0, t.filterIceServers)(r.iceServers, i.version)),
                    ...
                    switch (h.browser) {
                        case "chrome":
                            if (!r || !r.shimPeerConnection || !o.shimChrome)
                                return m("Chrome shim is not included in this adapter release."), d;
                        ...
                        case "safari":
                            if (!t || !o.shimSafari)
                                return m("Safari shim is not included in this adapter release."), d;
            ...
            function (require, module, exports) {
                ...
                Object.create &&
                    ...
                    (i.prototype.removeListener = function (e, n, r, o) {
                        ...
                        if (c.fn)
                            c.fn !== n || (o && !c.once) || (r && c.context !== r) || s(this, i);
                        else {
                            for (var f = 0, u = [], a = c.length; f < a; f++)
                                (c[f].fn !== n || (o && !c[f].once) || (r && c[f].context !== r)) &&
                                    u.push(c[f]);
                    ...
                    a = (function () {
                        ...
                        return (
                                ...
                                return n(this, void 0, Promise, function () {
                                    ...
                                    return t(this, function (t) {
                                        switch (t.label) {
                                            ...
                                            case 1:
                                                return (
                                                    t.trys.push([1, 7, , 8]), [4, e.createAnswer()]
                                                );
                                            case 2:
                                                (o = t.sent()),
                            ...
                            (o.prototype._addStreamToMediaConnection = function (e, n) {
                                r.default.log(
                                    "add stream " + e.id + " to media connection " + n.connectionId
                                ),
                                    n.addStream(e);
                            }),
                            o
